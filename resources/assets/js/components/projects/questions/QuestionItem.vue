      ...
      <div class="mw-100 text-muted d-flex justify-content-between align-items-center">
          <span class="d-flex flex-row align-items-center author-wrap">
            ...
            <span class="d-flex flex-column">
              ...
              <span style="font-size:.75rem;" class="font-italic">{{ question.created_at | datetime }} <span v-if="ownsQuestion(question)">• <a href="#" @click.prevent="deleteQuestion(question)" class="text-muted">Delete</a> or <a href="#" class="text-muted" @click.prevent="toggleEdit">Edit</a> Question</span></span>
            </span>
          </span>
