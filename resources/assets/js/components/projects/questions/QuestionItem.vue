      ...
      <div class="mw-100 text-muted d-flex justify-content-between align-items-center">
          <span class="d-flex flex-row align-items-center author-wrap">
            ...
            <span class="d-flex flex-column">
              ...
              <span style="font-size:.75rem;" class="font-italic">{{ question.created_at | datetime }} <span v-if="ownsQuestion">• <a href="#" @click.prevent="deleteQuestion(question)" class="text-muted">Delete Question</a></span></span>
            </span>
          </span>
